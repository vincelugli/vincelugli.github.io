...
const tournamentStages = [
  ...
  },
  {
    ...
    endDate: new Date("08/17/2025")
  },
  {
    number: 3,
    title: "Swiss Stage",
    description: "Teams play in a Swiss-system group stage to determine top seeds.",
    link: "/swiss",
